...
import { Film, Brain, Calendar, Loader2, Zap, CalendarHeart, BookHeart } from "lucide-react";
...
export default function Memories() {
  ...
  const fetchFullHistory = async () => {
    ...
    // Fetch Daily Syncs (Assume room_id is couple_id for simplicity in this revert)
  ...
  return (
    <div className="w-full max-w-md h-full overflow-y-auto pb-24 px-4 pt-4 space-y-8">
      ...
      {feed.map((group: any) => (
        <div key={group.month} className="space-y-4">
            <div className="sticky top-0 bg-zinc-950/90 backdrop-blur-md py-2 z-10 border-b border-white/5">
                <h3 className="text-xs font-bold uppercase tracking-widest text-zinc-400">{group.month}</h3>
            </div>
